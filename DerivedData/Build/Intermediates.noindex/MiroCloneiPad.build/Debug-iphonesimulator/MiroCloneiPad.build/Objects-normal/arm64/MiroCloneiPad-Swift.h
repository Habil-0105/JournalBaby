...
#ifndef MIROCLONEIPAD_SWIFT_H
#define MIROCLONEIPAD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MiroCloneiPad",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13MiroCloneiPad20AudioPlaybackManager")
@interface AudioPlaybackManager : NSObject <AVAudioPlayerDelegate>
...
SWIFT_CLASS("_TtC13MiroCloneiPad20AudioRecorderManager")
