...
- **Purpose:** Renders one page: background, scribble layer (interactive or static), elements, and a delete pill on the current page (`isCurrent`).
- **Key behaviour:**
